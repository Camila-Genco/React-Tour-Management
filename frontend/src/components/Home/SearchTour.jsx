        ...
        <div className='flex flex-col border rounded'>
            <div className='p-2 px-3 flex gap-3'>
                ...
                <div className='flex flex-col'>
                    ...
                    <input type="text" placeholder='Where are you going?' ref={locationRef} className='bg-transparent text-gray' />
                </div>
            </div>
        </div>        
        <div className='flex flex-col rounded border'>
            <div className='p-2 px-3 flex gap-3'>
                ...
                <div className='flex flex-col'>
                    ...
                    <input type="text" placeholder='Distance in km' ref={locationRef} className='bg-transparent text-gray' />
                </div>
            </div>
        </div>
        <div className='flex flex-col border  rounded'>
